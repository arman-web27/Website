  ...
  return (
    <section id="faqs" className="faqs-dark relative overflow-hidden bg-[#060605] px-6 py-24 text-white lg:px-8">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mb-14 flex flex-wrap items-end justify-between gap-6"><div><p className="section-eyebrow text-[#e0bd68]">Some Faq&apos;s</p><h2 className="section-heading mt-4">Work with a Dedicated <span className="text-[#e0bd68]">Facebook Ad Company</span></h2></div><p className="section-subheading max-w-md text-neutral-300">Our approach to Facebook Ads is uniquely built around what we know works—and what we know doesn&apos;t work—with over 200 verified factors in play.</p></div>
